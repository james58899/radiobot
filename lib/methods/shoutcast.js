module.exports = function (bridge) {
	bridge.allOnce(['get_router', 'mp3_stream', 'queue', 'config', 'analytics'], function (getRouter, mp3Stream, queue, config, analytics) {
		...
		router.get(/^(?:\/live.mp3|\/stream|\/;)(?:\?|$)/, function (req, res) {
			listenersCount++;
			analytics.updateListenerCount('shoutcast', listenersCount);
